//! Golden frames for protocol v23. Keep expected bytes independent of codec helpers.
...
#[test]
fn hello_request_and_response_match_v23_golden_frames() {
    assert_eq!(PROTOCOL_VERSION, 23);
    assert_request_golden(
        "hello request",
        &Request::Hello { client_version: 23 },
        &[
            0x0e, 0x00, 0x00, 0x00, 0x17, 0x00, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,
            0x01, 0x00, 0x17, 0x00,
        ],
    );
    assert_response_golden(
        ...
        &[
            0x14, 0x00, 0x00, 0x00, 0x17, 0x00, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,
            0x01, 0x80, 0x17, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x00,
        ],
    );
}

#[test]
fn representative_output_matches_v23_golden_frame() {
    assert_response_golden(
        "output response",
        ...
        &[
            0x1f, 0x00, 0x00, 0x00, 0x17, 0x00, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,
...
#[test]
fn representative_key_inputs_match_v23_golden_frames() {
    let cases = [
        (
            "ascii char",
            KeyInput {
            ...
            &[
                0x1e, 0x00, 0x00, 0x00, 0x17, 0x00, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,
        ...
        (
            ...
            &[
                0x1a, 0x00, 0x00, 0x00, 0x17, 0x00, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,
...
#[test]
fn every_mode_matches_its_v23_golden_frame() {
    let cases = [
        (Mode::Direct, 0x00),
        (Mode::Hiragana, 0x01),
        (Mode::Katakana, 0x02),
    ...
    for (mode, wire_value) in cases {
        let mut expected = vec![
            0x15, 0x00, 0x00, 0x00, 0x17, 0x00, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,
...
#[test]
fn every_input_scope_matches_its_v23_golden_frame() {
    let cases = [
...
#[test]
fn representative_appearance_and_pad_values_match_v23_golden_frames() {
    let cases = [
        (
            AppearanceTheme::Light,
            PadShortcut::Disabled,
            &[
                0x1d, 0x00, 0x00, 0x00, 0x17, 0x00, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,
